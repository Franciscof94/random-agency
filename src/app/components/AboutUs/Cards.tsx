...
export const Cards = ({ isMobile }: Props) => {
    return (
        <div>
            <div className='flex'>
                <div className='w-full max-w-[424px] h-72 sm:h-56 md:h-56 lg:h-64 xl:h-64 border-solid border-[1px] border-black-80 rounded-[70px] sm:rounded-[90px] bg-white'>
                    ...
                    <p className='px-6 text-center sm:p-0 md:px-6 lg:px-20 xl:px-20 sm:py-3 md:py-4 lg:py-5 xl:py-7 text-[13px] sm:text-sm md:text-sm lg:text-base'>Dialogamos y planteamos un reto para tu marca.</p>
                    {!isMobile && <Arrow className='float-end mx-16 py-6' />}
                </div>
                <div className='w-full max-w-[655px] h-72 sm:h-56 md:h-56 lg:h-64 xl:h-64 border-solid border-[1px] border-black-80 bg-white rounded-tl-[70px] rounded-br-[70px] sm:rounded-tl-[90px] sm:rounded-br-[90px]'>
            ...
            <div className='flex'>
                <div className='w-full max-w-[592px] h-72 sm:h-56 md:h-56 lg:h-64 xl:h-64 border-solid border-[1px] border-black-80 bg-white rounded-br-[70px] sm:rounded-br-[90px]'>
                    ...
                    <p className='px-6 text-center sm:p-0 md:px-6 lg:pl-20 lg:pr12 xl:pl-20 xl:pr-12 sm:py-3 md:py-4 lg:py-5 xl:py-7 text-[13px] sm:text-sm md:text-sm lg:text-base'>Somos una agencia creativa que combina estrategia y creatividad. Analizamos meticulosamente cada problema antes de proponer soluciones innovadoras y efectivas.</p>
                    {!isMobile && <Arrow className='float-end mx-16 py-0.5' />}
                </div>
                <div className='w-full max-w-[486px] h-72 sm:h-56 md:h-56 lg:h-64 xl:h-64 border-solid border-[1px] border-black-80 rounded-[70px] sm:rounded-[90px] bg-white'>
